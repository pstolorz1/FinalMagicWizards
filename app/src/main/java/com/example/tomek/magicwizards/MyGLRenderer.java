...
//!  Klasa zajmujaca sie wyswietlaniem przy użyciu openGL
/*!
  inicjalizacja openGL, rysowanie gwiazdek i obliczanie pozycji w przestrzeni openGL
*/
public class MyGLRenderer implements GLSurfaceView.Renderer
{
    //! gwiazda pojawiająaca sie co jakis czas podczas robienia gestu
    Star bigStar;
    ...
    //! ilość gwiazdek do wyswietlenia
    int sqNumber = 20;
    //! zmienna pomocnicza, w ktorej przechowywana jest skala dużej gwiazdy
    float scaleFactor = 1.0f;
    //! zmienna pomocnicza, w ktorej przechowywana jest przezroczystosc(kanał alpha) duzej gwiazdy
    float alphaFactor = 0.0f;
    //! lista wspołrzednych malych gwiazdek
    public List<Vec2> trail = new ArrayList<>();
    //! lista obiektow (małych gwiazdek)
    ...
    //! Metoda tworzaca nową linię z gwiazdek na podstawie wspołrzednych gestu
    /*!
      \param positions wspolrzedne punktow składajacych sie na gest
      \param trailLength dlugosc gestu
    */
